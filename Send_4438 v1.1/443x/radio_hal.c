...
#define SDN_L()       GPIO_ResetBits(GPIOA,GPIO_Pin_1)                 //芯片内部LDO使能信号，低电平正常供电，高电平停止供电，功耗最小 
#define SDN_H()       GPIO_SetBits(GPIOA,GPIO_Pin_1)

#define IRQ_READ()    GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_5)         //中断输出引脚，有中断时输出低
